...
#Import data
setwd("C:/Users/LENOVO T46OS/Desktop/C:/Users/LENOVO T46OS/Desktop/sdc-bgd-mcna-r2-hh-level")
...
selectedKeyVars <- c('enum_gender',	'upazila_name', 'union_name',
...
cols =  c('enum_gender',	'upazila_name', 'union_name',
          'respondent_age', 'respondent_gender',
          'respondent_hoh',	'hoh_gender',
          'hoh_age',	'hoh_marital',	'hh_size')
